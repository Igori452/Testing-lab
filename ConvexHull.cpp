...
/*
Суть алгоритма: найти внешнюю ыпуклую оболочку

Разбиение на класса:
- Множество точек расположенных хаотично
- Все точки на плоскости образуют линию
- Точек ровно 3 и они не лежат на одной прямой
- Точек ровно 2
- Одна точка или множество точек, но с одинаковыми координатами
- Пустое множество точек

Разбиение на граничные условия:
- 0 точек
- 1 точка
- 2 точки
- 3 точки
- 4 точки
- (N - 1) точка лежит на прямой одна выступает (N > 4)
- N точек совпадает и одна выступает
*/
