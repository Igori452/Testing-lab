...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "10.2.0"
  WORKING_DIRECTORY "C:/work/c++/testedProject/build/_deps/harfbuzz-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/work/c++/testedProject/build/_deps/harfbuzz-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/work/c++/testedProject/build/_deps/harfbuzz-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
